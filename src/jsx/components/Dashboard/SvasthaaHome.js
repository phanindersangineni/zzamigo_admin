								...
								<div className="card-body">
									<div className="row">
										<div className="col-xl-5 col-xxl-12 col-md-5">
											<h4 className="fs-20 text-black mb-4 font-w700">Running Orders</h4>
											<div className="row">
												<div className="d-flex col-xl-12 col-xxl-6  col-md-12 col-6 mb-4">
													...
													<div>
														<p className="fs-14 mb-2">New Orders</p>
												...
												<div className="d-flex col-xl-12 col-xxl-6 col-md-12 col-6 mb-4">
													...
													<div>
														<p className="fs-14 mb-2">Running Orders</p>
														<span className="fs-16 font-w600 text-light"><span className="text-black me-2 font-w700">$1,567</span>/$5,000</span>
													</div>
												</div>
												<div className="d-flex col-xl-12 col-xxl-6 col-md-12 col-6 mb-4">
													...
													<div>
														<p className="fs-14 mb-2">Ready For Delivery</p>
														<span className="fs-16 font-w600 text-light"><span className="text-black me-2 font-w700">$1,567</span>/$5,000</span>
													</div>
												</div>
												<div className="d-flex col-xl-12 col-xxl-6 col-md-12 col-6 mb-4">
													...
													<div>
														<p className="fs-14 mb-2">Delivered</p>
														<span className="fs-16 font-w600 text-light"><span className="text-black me-2 font-w700">$1,567</span>/$5,000</span>
													</div>
												</div>
											</div>
											...
											<div className="row">
												<div className="col-sm-6 mb-4">
													<div className="bg-gradient1 rounded text-center p-3">
														...
														<span className="fs-14 text-white d-block">New Orders</span>
													</div>
												</div>
												<div className="col-sm-6 mb-4">
													<div className="bg-gradient2 rounded text-center p-3">
														...
														<span className="fs-14 text-white d-block">Running Orders</span>
													</div>
												</div>
												<div className="col-sm-6 mb-sm-0 mb-4">
													<div className="rounded text-center p-3 bg-gradient3">
														...
														<span className="fs-14 text-white d-block">Ready For Pickup</span>
													</div>
												</div>
												<div className="col-sm-6 mb-sm-0 mb-4">
													<div className="rounded text-center p-3 bg-gradient4">
														...
														<span className="fs-14 text-white d-block">Delivered</span>
													</div>
												</div>
											</div>
										</div>
							...
							<div className="card">
								<div className="card-header d-sm-flex d-block border-0 pb-0">
									<div className="pe-3 me-auto mb-sm-0 mb-3">
										<h4 className="fs-20 text-black mb-1 font-w700">Orders Overview</h4>
							...
							<div className="row">
									...
									<div className="card">
										<div className="card-header border-0 pb-0">
											<div>
												...
												<span className="fs-12">allows you to tranfer the earnings to your bank account</span>
											</div>
											<Dropdown className="dropdown">
												<Dropdown.Toggle as="div" className="btn-link i-false">
								...
								<div className="col-xl-6 col-xxl-12 col-sm-6">
									<div className="card">
										<div className="card-header border-0 pb-0">
											<div>
												<h4 className="mb-2 fs-20 font-w700">Collection Breakup</h4>
												<span className="fs-12">Total Amount Collected breakup</span>
											</div>
