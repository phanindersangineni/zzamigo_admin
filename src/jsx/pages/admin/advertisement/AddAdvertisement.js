...
import { SaveAdvertisement, SaveBanner, SaveLogos, UpdateAdvertisement, UpdateBanner, UpdateLogos } from '../../../../services/CommonService';
...
const AddAdvertisement = ({ tenantprop, updateprop }) => {
    ...
    const submitForm = async () => {
        ...
        if (isValid) {
            ...
            if (!formfields.id) {
                //save
                const Response = await SaveAdvertisement(formfields);
                if (Response.data.id) {
                ...
                //update
                const Response = await UpdateAdvertisement(formfields);
                if (Response.data.id) {
    ...
    return (<>
        ...
        <div className="form-group mb-3 row">
            ...
            <div className="errorMsg">{errorFields.image}</div>
        </div>
