...
import { DeleteBannerImage, DeleteSubCategory, GetAllAreas, GetAllBanner, GetAllBranches, GetAllLogos, GetAllSubCategory, GetAllTenants, deletLogoImages, getAllArea } from '../../../../services/CommonService';
...
const SubCategory = () => {
    ...
    const loadData = async (pn) => {
        ...
        const respData = await GetAllSubCategory(reqparams);
            ...
            <Col lg={12}>
                <Card>
                    <Card.Header>
                        ...
                        <Card.Title>SubCategory <Button onClick={() => openModal(1, '')}
