...
import { DeleteBannerImage, DeleteStoreCharges, GetAllAreas, GetAllBanner, GetAllBranches, GetAllLogos, GetAllStoreCharges, GetAllSubCategory, GetAllTenants, deletLogoImages, getAllArea } from '../../../../services/CommonService';
import { Badge, Button, Card, Col, Dropdown, Modal, Table } from "react-bootstrap"
import { Link } from "react-router-dom";
import { ToastContainer, toast } from 'react-toastify';
import Pagination from "react-js-pagination";
import EventBus from '../../../../services/EventBus';
import AddStoreCharges from './AddStoreCharges';
...
const StoreCharges = () => {
    ...
    const loadData = async (pn) => {
        ...
        const respData = await GetAllStoreCharges(reqparams);
            ...
            <Col lg={12}>
                <Card>
                    <Card.Header>
                        ...
                        <Card.Title>Store Charges<Button onClick={() => openModal(1, '')}
                            className="me-2" variant="primary btn-square"
                            title="Add Store Charges"
                        >
