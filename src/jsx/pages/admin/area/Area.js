...
import { DeleteBannerImage, GetAllAreas, GetAllBanner, GetAllBranches, GetAllLogos, GetAllTenants, deletLogoImages, getAllArea } from '../../../../services/CommonService';
import { Badge, Button, Card, Col, Dropdown, Modal, Table } from "react-bootstrap"
import { Link } from "react-router-dom";
import { ToastContainer, toast } from 'react-toastify';
import Pagination from "react-js-pagination";
import EventBus from '../../../../services/EventBus';
import AddAreas from './AddArea';
      ...
      <Col lg={12}>
        <Card>
          <Card.Header>
            ...
            <Card.Title>Areas <Button onClick={() => openModal(1, '')}
            ...
            <form >
              ...
              <div className="modal-body">
                ...
                <Suspense fallback={<div>Loading</div>}>
                  {/* <AddAreas updateprop={updateitem} /> */}
                  <AddAreas  updateprop={updateitem}/>
                   </Suspense>
              </div>
