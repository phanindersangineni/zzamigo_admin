...
import { DeleteBannerImage, DeleteSubCategory, GetAllAreas, GetAllBanner, GetAllBranches, GetAllComission, GetAllLogos, GetAllSubCategory, GetAllTenants, deletLogoImages, getAllArea } from '../../../../services/CommonService';
...
const Comission = () => {
    ...
    const loadData = async (pn) => {
        ...
        const respData = await GetAllComission(reqparams);
            ...
            <Col lg={12}>
                <Card>
                    <Card.Header>
                        ...
                        <Card.Title>Comission <Button onClick={() => openModal(1, '')}
                        ...
                        <form >
                            ...
                            <div className="modal-body">
                                ...
                                <Suspense fallback={<div>Loading</div>}>
                                    ...
                                    <AddComission updateprop={updateitem} />
                                </Suspense>
                            </div>
