...
const Logo = () => {
  ...
  return (
    <>
    {
    console.log("respData.data.docs==",data)
    }
      <ToastContainer
        position="top-center"
        autoClose={5000}
      ...
      <Col lg={12}>
        <Card>
          <Card.Header>
            ...
            <Card.Title>Logo <Button onClick={() => openModal(1, '')}
            ...
            <Table responsive>
              <thead>
                <tr>
                  ...
                  <th>
                    <strong>Large Icon</strong>
                  </th>
                  <th>
                    <strong> Intro Content Banner</strong>
                  </th>
                  <th>
                    <strong>Small Icon</strong>
                  </th>
                  <th>
              ...
              <tbody>
                {data.map(item => (
                  <tr>
                    ...
                    <td>
                      <img style={{ "height": "100px" }} src={item.webicon} alt="Red dot" />
                    </td>
                    <td>
                      <img style={{ "height": "100px" }} src={item.smallicon} alt="Red dot" />
                    </td>
                    <td>
                      <img style={{ "height": "100px" }} src={item.favicon} alt="Red dot" />
                    </td>
                    <td>{item.status}</td>
                    <td></td>
            ...
            <form >
              ...
              <div className="modal-body">
                ...
                <Suspense fallback={<div>Loading</div>}>
                  <AddLogo tenantprop={tenantdata} updateprop={updateitem} /> </Suspense>
              </div>
