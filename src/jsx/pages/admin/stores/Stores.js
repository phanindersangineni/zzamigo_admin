...
import { GetAllStores, GetAllTenants, GetCategory } from "../../../../services/CommonService";
    ...
    return (
        <>
            ...
            {/* <Accordion className="accordion accordion-danger-solid" defaultActiveKey="0">
                ...
                <Card>
                    <Card.Header>
                        <Card.Title>Stores <Button onClick={() => addModal()}
                        ...
                        <form >
                            ...
                            <div className="modal-body">
                                        ...
                                        <Suspense fallback={<div>Loading</div>}>
                                            {/* <AddCategory tenantprops={tenantlist} updateprop ={updatedata} /> */}
                                            <AddStores tenantprops={tenantlist} updateprop ={updatedata}/>
                                             </Suspense>
